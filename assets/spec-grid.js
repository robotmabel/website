...
(function () {
  ...
  var HERO = [
    ...
    ['5.4', 'kg', 'payload per arm', 'Static actuator-torque limit at full extension',
     'Table I'],
    ['8,056', '$', 'bill of materials', 'Listed parts, Raspberry Pi configuration. No machine shop',
     'BOM/README.md'],
  ...
  var FULL = [
    ...
    ['Wrists', '2 × 720p global-shutter RGB'],
    ['Base', 'LD19 2-D lidar; depth camera optional'],
    ['Compute', 'Raspberry Pi 5 16 GB; Jetson upgrades optional'],
    ...
    ['Bill of materials', '$9,283 recommended · $8,056 essential'],
    ['Licence', 'MIT'],
  ];
